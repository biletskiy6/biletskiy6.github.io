...
$(function(){
    ...
    $(".toggle-menu").on("click", function(){
      ...
      $(".main-menu__link").toggleClass('animated fadeInUp');
  });

    $('.main-header').height(window.innerHeight + 'px');
 ...
 $('.portfolio-items').slick({
    ...
    responsive: [
    {
        ...
        settings: {
            ...
            slidesToScroll: 1,
            adaptiveHeight: true,
            prevArrow: "<svg width='15' height='23' viewBox='0 0 15 23' class='slick-arrow--left'><use xlink:href='static/img/svg/sprite.svg#left-arrow'/></svg>",
            nextArrow: "<svg width='15' height='23' viewBox='0 0 15 23' class='slick-arrow--right'><use xlink:href='static/img/svg/sprite.svg#right-arrow'/></svg>",
        }
    },
    ]
});
...
var $isAnimatedHome = $('.main-header .is-animated');
var $isAnimatedSecond = $('.s-about .is-animated');
var $isAnimatedThird = $('.s-skills .is-animated');
var $isAnimatedFourth = $('.s-portfolio .is-animated');
var $isAnimatedFifth = $('.s-contacts .is-animated');
var $isAnimatedSixth = $('.test-section .is-animated');
var sectChildren = $("#fullpage").children();
console.log(sectChildren.length - 1);
$('#fullpage').fullpage({
    anchors:['home', 'about', 'skills', 'portfolio', 'contacts'],
    autoScrolling: true,
    scrollHorizontally: false,
    scrollingSpeed: 1000,
    fixedElements: '.logo, .toggle-menu, .main-header__nav',
    licenseKey: 'OPEN-SOURCE-GPLV3-LICENSE',
    afterLoad: function(index, nextIndex, direction){
        if(nextIndex.index == 0) {
            $isAnimatedHome.eq(0).addClass('animated fadeInLeft').css('animation-delay', '.2s');
            $isAnimatedHome.eq(1).addClass('animated fadeInRight').css('animation-delay', '.2s');
            $isAnimatedHome.eq(2).addClass('animated fadeIn').css('animation-delay', '.5s'); 
            $isAnimatedHome.eq(3).addClass('animated fadeIn').css('animation-delay', '.5s'); 
            $isAnimatedHome.eq(4).addClass('animated fadeInUp').css('animation-delay', '.4.5s'); 
            $isAnimatedHome.eq(5).addClass('animated fadeInLeft').css('animation-delay', '.2s'); 
            $isAnimatedHome.eq(6).addClass('animated fadeInRight').css('animation-delay', '.2s'); 
        }
    },
    onLeave: function(index, nextIndex, direction) {
        if(nextIndex.index == 1) {
           $isAnimatedSecond.eq(0).addClass('animated fadeIn').css('animation-delay', '1s'); 
           $isAnimatedSecond.eq(1).addClass('animated fadeInLeft').css('animation-delay', '.6s'); 
           $isAnimatedSecond.eq(2).addClass('animated fadeInLeft').css('animation-delay', '.6s'); 
           $isAnimatedSecond.eq(3).addClass('animated fadeInLeft').css('animation-delay', '.6s'); 
           $isAnimatedSecond.eq(4).addClass('animated fadeInRight').css('animation-delay', '.1s');
       }
       if(nextIndex.index == 2) {
           $isAnimatedThird.eq(0).addClass('animated zoomInUp').css('animation-delay', '.8s'); 
           $isAnimatedThird.eq(1).addClass('animated fadeInLeft').css('animation-delay', '.4s'); 
           $isAnimatedThird.eq(2).addClass('animated fadeInLeft').css('animation-delay', '.6s'); 
           $isAnimatedThird.eq(3).addClass('animated fadeInLeft').css('animation-delay', '.8s'); 
           $isAnimatedThird.eq(4).addClass('animated fadeInRight').css('animation-delay', '.8s');
       }
       if(nextIndex.index == 3) {
           $isAnimatedFourth.eq(0).addClass('animated zoomInUp').css('animation-delay', '.8s'); 
           $isAnimatedFourth.eq(1).addClass('animated fadeInLeft').css('animation-delay', '.4s'); 
           $isAnimatedFourth.eq(2).addClass('animated fadeInLeft').css('animation-delay', '.6s'); 
           $isAnimatedFourth.eq(3).addClass('animated fadeIn').css('animation-delay', '.4s'); 
           $isAnimatedFourth.eq(4).addClass('animated fadeIn').css('animation-delay', '.6s'); 
           $isAnimatedFourth.eq(5).addClass('animated fadeIn').css('animation-delay', '.8s'); 
           $isAnimatedFourth.eq(6).addClass('animated fadeIn').css('animation-delay', '1s'); 

           $.ajax({ 
            type: 'GET',
            url: '../contacts.html', 
            success: function(response){
                  var newSection = $("<section class='section'></section>");
                newSection.html(response);
                $("#fullpage").append(newSection);
                $(".s-contacts .fp-tableCell").html(response);
                $isAnimatedFifth = $('.s-contacts .is-animated');
            }
        });
       }
    
     /*  if(nextIndex.index == sectChildren.length - 1) {
          $.ajax({ 
            type: 'GET',
            url: '../contacts.html', 
            success: function(response){
...
$(".portfolio-item__link").on('click', function(e) {
    e.preventDefault();
    var hrefToShow = $(this).attr('href');
    $('.js-overlay-campaign').fadeIn();
    $('.js-overlay-campaign').addClass("disabled");
    imgString = $(this).find("img").attr("src");
    imgHref = imgString.substr(imgString.lastIndexOf('/')+1);
    $('.popup').prepend('<img class="popup__photo" src="static/img/content/portfolio/portfolio-items--full/' + imgHref + '">');
    $('.button--portfolio').attr('href', hrefToShow);
});

$(".js-close-campaign").on('click', function() {
 $('.js-overlay-campaign').fadeOut();
 $('.popup').find("img").fadeOut('slow', function() {$(this).remove()});
});
...
$.each($('textarea[data-autoresize]'), function() {
    ...
    var resizeTextarea = function(el) {
        $(el).css('height', '40px').css('height', el.scrollHeight + offset);
    };
...
function doScroll() {
   ...
   console.log(windowScroll, documentHeight, scrolled);
}
